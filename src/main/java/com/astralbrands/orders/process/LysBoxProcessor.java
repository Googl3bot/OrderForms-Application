...
@Component
public class LysBoxProcessor implements BrandOrderForms, AppConstants {
...
//        colName.put(TAX_CURRENCY, 20); // Not used
    ...
    public void process(Exchange exchange, String site, String[] fileNameData) {
        ...
        try {
            ...
            String siteName = fileNameData[2];
            ...
            if (txtFileData != null) {
                ...
                exchange.setProperty(CSV_DATA, txtFileData.replace(TILDE, COMMA));
                ...
                exchange.setProperty(SITE_NAME, siteName);
                exchange.setProperty(BRAND, "PUR_40BOXES");
            } else {
