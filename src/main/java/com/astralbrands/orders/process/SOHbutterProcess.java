...
@Component
public class SOHbutterProcess implements BrandOrderForms, AppConstants{
...
//                exchange.setProperty(INPUT_FILE_NAME, "CommerceHub(PUR)_" + index); // 1st implementation of CSV file
                ...
                exchange.getMessage().setHeader(Exchange.FILE_NAME, today + "_YNSOHT" + index + DOT_TXT); // Formatting the TXT file
